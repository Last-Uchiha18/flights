    ...
    return (
        <div className='advt' id="aboutComponent">
            ...
            <div className='advtGroup'>
                <li className='item'>
                    <LazyLoadImage src="/flights/abike.svg" alt="" className='svg'/>
                    <h3>Select Bike</h3>
                    <p>We offers a big range of vehicles for all your driving needs. We have the perfect car to meet your needs</p>
                </li>
                <li className='item'>
                    <LazyLoadImage src="/flights/op.svg" alt="" className='svg'/>
                    <h3>Contact Operator</h3>
                    <p>Our knowledgeable and friendly operators are always ready to help with any questions or concerns</p>
                </li>
                <li className='item'>
                    <LazyLoadImage src="/flights/mbike.svg" alt="" className='svg'/>
                    <h3>Let&apos;s Drive</h3>
